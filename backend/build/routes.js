...
const router = app => {
  ...
  app.get("/sectors", _settings.sectors);
  app.get("/participations", _participation.participations);
  app.get("/associates", _settings.associates);
  ...
  app.post("/pages", _settings.pages);
  app.post("/add_participate", _participation.add_participate);
  ...
  app.post("/page", _settings.page);
  app.post("/update_page", _settings.update_page);
