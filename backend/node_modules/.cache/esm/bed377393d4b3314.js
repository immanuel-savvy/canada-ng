let ASSOCIATES,CONFERENCES,GLOBALS,PAGES,SECTORS,SEMINARS,SPONSORS,TEAM_MEMBER,gds,remove_image,save_image,save_video;_3d4‍.x([["GLOBAL_sponsors",()=>GLOBAL_sponsors],["GLOBAL_speakers",()=>GLOBAL_speakers],["update_page",()=>update_page],["page",()=>page],["GLOBAL_banner_stuff",()=>GLOBAL_banner_stuff],["upcoming_event",()=>upcoming_event],["add_banner",()=>add_banner],["banners_et_logo",()=>banners_et_logo],["pages",()=>pages],["update_banner",()=>update_banner],["GLOBAL_internship",()=>GLOBAL_internship],["GLOBAL_logo",()=>GLOBAL_logo],["logo_update",()=>logo_update],["remove_banner",()=>remove_banner],["internship",()=>internship],["sponsors_page",()=>sponsors_page],["speakers_page",()=>speakers_page],["update_speakers",()=>update_speakers],["update_sponsors",()=>update_sponsors],["update_internship",()=>update_internship],["GLOBALS_mission_statement",()=>GLOBALS_mission_statement],["GLOBALS_vision_statement",()=>GLOBALS_vision_statement],["donation_section",()=>donation_section],["update_donation_section",()=>update_donation_section],["GLOBAL_donation_section",()=>GLOBAL_donation_section],["update_live_training",()=>update_live_training],["live_training",()=>live_training],["GLOBAL_live_training",()=>GLOBAL_live_training],["update_mission",()=>update_mission],["update_mentorship",()=>update_mentorship],["mentorship",()=>mentorship],["GLOBAL_mentorship",()=>GLOBAL_mentorship],["update_vision",()=>update_vision],["mission_vision_statement",()=>mission_vision_statement],["update_about_statement",()=>update_about_statement],["about_statement",()=>about_statement],["GLOBALS_sectors",()=>GLOBALS_sectors],["get_sectors",()=>get_sectors],["update_sectors",()=>update_sectors],["GLOBALS_about_statement",()=>GLOBALS_about_statement],["update_event_highlight",()=>update_event_highlight],["entry",()=>entry],["add_sector",()=>add_sector],["update_sector",()=>update_sector],["remove_sector",()=>remove_sector],["sectors",()=>sectors],["add_associate",()=>add_associate],["update_associate",()=>update_associate],["remove_associate",()=>remove_associate],["GLOBAL_flier_stuff",()=>GLOBAL_flier_stuff],["associates",()=>associates],["flier_stuff",()=>flier_stuff],["handle_flier_stuff",()=>handle_flier_stuff],["GLOBAL_upcoming_event",()=>GLOBAL_upcoming_event]]);_3d4‍.w("../ds/conn",[["ASSOCIATES",["ASSOCIATES"],function(v){ASSOCIATES=v}],["CONFERENCES",["CONFERENCES"],function(v){CONFERENCES=v}],["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["PAGES",["PAGES"],function(v){PAGES=v}],["SECTORS",["SECTORS"],function(v){SECTORS=v}],["SEMINARS",["SEMINARS"],function(v){SEMINARS=v}],["SPONSORS",["SPONSORS"],function(v){SPONSORS=v}],["TEAM_MEMBER",["TEAM_MEMBER"],function(v){TEAM_MEMBER=v}],["gds",["gds"],function(v){gds=v}]]);_3d4‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["save_image",["save_image"],function(v){save_image=v}],["save_video",["save_video"],function(v){save_video=v}]]);
