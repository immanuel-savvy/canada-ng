let GLOBALS,REVIEWS,VIDEO_REVIEWS,remove_image,remove_video,save_image,save_video;_35a‍.x([["update_alumni_overview",()=>update_alumni_overview],["alumni_overview",()=>alumni_overview],["GLOBAL_alumni_overview",()=>GLOBAL_alumni_overview],["update_video_review",()=>update_video_review],["remove_review",()=>remove_review],["remove_video_review",()=>remove_video_review],["video_reviews",()=>video_reviews],["new_review",()=>new_review],["approve_review",()=>approve_review],["new_video_review",()=>new_video_review],["reviews",()=>reviews]]);_35a‍.w("../ds/conn",[["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["REVIEWS",["REVIEWS"],function(v){REVIEWS=v}],["VIDEO_REVIEWS",["VIDEO_REVIEWS"],function(v){VIDEO_REVIEWS=v}]]);_35a‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["remove_video",["remove_video"],function(v){remove_video=v}],["save_image",["save_image"],function(v){save_image=v}],["save_video",["save_video"],function(v){save_video=v}]]);
