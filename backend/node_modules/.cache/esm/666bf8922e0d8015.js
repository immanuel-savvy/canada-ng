let GALLERY,save_video,remove_image,remove_video,save_image;_2e0‍.x([["new_media",()=>new_media],["remove_media",()=>remove_media],["fetch_media",()=>fetch_media],["update_media",()=>update_media]]);_2e0‍.w("../ds/conn",[["GALLERY",["GALLERY"],function(v){GALLERY=v}]]);_2e0‍.w("./utils",[["save_video",["save_video"],function(v){save_video=v}],["remove_image",["remove_image"],function(v){remove_image=v}],["remove_video",["remove_video"],function(v){remove_video=v}],["save_image",["save_image"],function(v){save_image=v}]]);
