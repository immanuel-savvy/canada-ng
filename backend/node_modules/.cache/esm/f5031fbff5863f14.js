...
const comments = (req, res) => {
  let { article, skip, limit } = req.params;
  let comments_ = COMMENTS.read({ item: article }, { skip, limit });
...
const new_comment = (req, res) => {
  ...
  comment.item.startsWith("article") &&
    ARTICLES.update(comment.item, { comments: { $inc: 1 } });
